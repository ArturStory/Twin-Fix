...
export default function CleanMessaging() {
  ...
  const createConversationMutation = useMutation({
    ...
    onSuccess: (newConversation) => {
      ...
      toast({
        ...
        description: `Started conversation with ${newConversation.otherUser.username}`
      });
    },
    onError: (error: any) => {
      toast({
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <Card className="h-[600px]">
        <div className="flex h-full">{/* Debug: selectedConversationId = {selectedConversationId}, selectedConversation = {selectedConversation ? 'found' : 'not found'} */}
